    ...
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      {isAdmin && (
        <div className="flex shrink-0 flex-wrap items-center justify-between gap-3 border-border px-4 py-4 sm:px-8">
          ...
          <div className="alert alert-warning flex items-center gap-2 rounded-ir-md border border-ir-warning/30 bg-ir-warning/10 px-3 py-2 text-xs font-medium text-ir-warning shadow-none">
