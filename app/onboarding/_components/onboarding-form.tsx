  ...
  return (
    <main className="grid min-h-screen place-items-center bg-page px-4 py-4">
      <div className="w-full max-w-lg">
        <Link
          className="mb-5 flex justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ir-primary/40"
          href="/"
        >
          <Image
            alt={PRODUCT_NAME}
        ...
        <Card>
          ...
          <CardContent>
            <form className="space-y-6" onSubmit={onSubmit}>
              {generalError && (
                <p className="bg-ir-danger/10 p-3 text-sm text-ir-danger">
                  {generalError}
                </p>
              )}
              ...
              <div className="space-y-1">
                <label
                  className="block text-sm font-semibold text-ir-heading"
                ...
                />
                {nameError && (
                  <p className="text-xs text-ir-danger">{nameError}</p>
                )}
              </div>
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  {slugLocked && (
                    <button
                      className="cursor-pointer text-xs text-ir-muted underline underline-offset-2 hover:text-ir-heading transition-colors duration-150"
